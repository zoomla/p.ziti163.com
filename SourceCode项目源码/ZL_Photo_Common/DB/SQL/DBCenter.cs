...
namespace ZoomLa.SQLDAL
{
    public static class DBCenter
    {
        ...
        public static DataTable JoinQuery(string fields, string mtable, string stable, string on, string where = "", string order = "", SqlParameter[] sp = null, string pk = "ID")
        {
        ...
        public static int Count(string tbname, string where, List<SqlParameter> sp, params Sql_Where[] whereList)
        {
            ...
            model.spList = sp;
            try { return DataConvert.CLng(DB.ExecuteScalar(model)); } catch { return 0; }
        }
        //-------------------
